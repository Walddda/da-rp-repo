                ...
                <div class="main-form-row">
                    <div class="main-form-element">
                        <label class="custom-text-label" for="description">Description</label><br>
                            ...
                            id="description"
                            v-model="track.is_beat.description"
                        />
                    </div>
                </div>
                <div class="main-form-row">
...
export default {
	...
	methods: {
        ...
        upload(e){
            ...
            formData.append('title', this.track.is_beat.title);
            formData.append('userID', this.$page.props.auth.user.id);
            formData.append('bpm', this.track.is_beat.bpm);
            formData.append('tagsArr', tagsFin);
            formData.append('selectedKey', this.track.is_beat.key);
            formData.append('type', this.track.is_beat.type);
            formData.append('description', this.track.is_beat.description);
            formData.append('feature', this.track.is_beat.feature);
